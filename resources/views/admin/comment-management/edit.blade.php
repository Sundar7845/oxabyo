            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 page-title-custom">
                        ...
                        href="{{ route('comment-management.index') }}">Back</a>
                            ...
                            <div class="col-md-6 offset-3 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form action="{{ route('comment-management.update', $comment->id) }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description" value = "{{ $comment->description }}" class="form-control">
                                            </div>
