                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('event-management.store') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" name="match_hour" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="prize_money" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label><strong>OXARATE Min : </strong></label>
                                                <input type="text" name="oxarate_min" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label><strong>Performance Rating Min : </strong></label>
                                                <input type="text" name="performance_rating_min" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label><strong>Ynfluence Rating Min : </strong></label>
                                                <input type="text" name="ynfluence_rating_min" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label><strong>Monetization Rating Min : </strong></label>
                                                <input type="text" name="monetization_rating_min" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12 m_b10">
                                                        <input type="checkbox" value="1" name="allow_players_streaming"><strong> Allow
