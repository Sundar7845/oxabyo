                        ...
                        <td class="text-right">
                            <ul class="list-inline m_b0">
                                <li>
                                    <a data-id="{{ $member->id }}"
                                        class="
                                            @if ($member->is_admin) btn btn-icon teamAdminClass removeAdmin
                                            @else
                                                btn btn-icon teamAdminClass addAdmin @endif "
                                ...
                                <li>
                                    ...
                                    <a data-id="{{ $member->id }}"
                                        class="
                                            @if ($member->status) btn btn-icon teamBanClass banAdmin
                                            @else
                                                btn btn-icon teamBanClass unbanAdmin @endif "
                                                data-toggle="tooltip" data-placement="left" data-original-title="
                                            @if ($member->status) BAN USER FROM TEAM
                                            @else
                                            UNBAN USER FROM TEAM @endif
                                        ">
                                        <i class="
